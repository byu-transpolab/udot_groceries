...
quality goods. In response, some public agencies and community groups have executed programs
to improve the offerings and display of more nutritive products [@young2018; @haboush2023healthy].
To examine the potential for this strategy to improve access to
...
scenario_map_theme <- theme(
  ...
  legend.key.width = grid::unit(0.10, "in")
)
...
most broadly distributed gains. In this figures the distribution of benefits is shown in color,
but the reader should note that the scale of benefits is not uniform across the
scenarios, and is marked instead by the numeric values on the legend.
