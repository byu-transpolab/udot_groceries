...
p <- lapply(seq_along(1:nrow(map_regions)), function(i){
  ...
  ggplot() +
    ...
    geom_sf(data = map_regions$grocery[[i]], mapping = aes(size = total_registers), color = "grey40", alpha = 0.5) +
    ...
    scale_size_manual("Total Registers", values = c("<5" = 1, "5-10" = 2, "10-25" = 3, ">25" = 4), na.value = NA,
