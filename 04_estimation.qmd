...
total access (with car inlcuded) is a smooth gradient across the valley, the 
access for individuals without vehicles is blocky and discontinuous, with neighboroods
...
below 0, whereas the *maximum* log-sum without vehicles is around -70.
