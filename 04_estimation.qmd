...
\end{align*} The Access model includes only the mode choice logsum described in
...
goods and more advantagous prices for those goods, all else equal. The
