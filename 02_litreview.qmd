...
store quality, and observed tradeoffs between the two. @macfarlane2021modeling
...
organization
(1) the inconsistent parameters used across studies, (2) the lack of consideration for multi-modal travel, (3) the lack of behavior components to reflect the decision-making process such as mode choice and destination selection, and (4) the need to distinguish various stores in the study area.
