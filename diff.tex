...
%DIF ADD Where-s-dinner-coming-from--A-utility-based-investigation-of-access-to-nutrition-in-Utah..tex   Fri May 15 14:34:04 2026
...
this literature can be had from \DIFdelbegin \DIFdel{(}\DIFdelend Beaulac et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2009) and \DIFdelbegin \DIFdel{(}\DIFdelend Walker et al.
\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2010). More recent work has extended the description and refinement of
the measures used to evaluate food access and control for confounding
variables. \DIFdelbegin \DIFdel{(}\DIFdelend Widener \& Shannon \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2014) considered that temporal access to
quality food is as important as spatial access. \DIFdelbegin \DIFdel{(}\DIFdelend Aggarwal et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2014)
...
By contrast, \DIFdelbegin \DIFdel{(}\DIFdelend Chen et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2016) compared spatial access to quality food
vendors with observed food expenditures and showed poor access explained
obesity even when controlling for consumption. \DIFdelbegin \DIFdel{(}\DIFdelend Cooksey-Stowers et al.
\DIFdelbegin \DIFdel{,
}\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2017) jointly pursued spatial proximity with quality of offerings and
...
between the two. \DIFdelbegin \DIFdel{(}\textbf{\DIFdel{macfarlane2021b?}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{Macfarlane et al. (2021}\DIFaddend ) illustrated the potential for
...
a policy analysis of park space during Covid-19 (Macfarlane et al.,
...
\DIFaddbegin \DIFadd{organization (1) the inconsistent parameters used across studies, (2)
the lack of consideration for multi-modal travel, (3) the lack of
behavior components to reflect the decision-making process such as mode
choice and destination selection, and (4) the need to distinguish
various stores in the study area.
}

\DIFadd{Equitable access to community resources has been a topic of research and
...
\DIFadd{In addition to economic opportunity, the connection between well-being
...
\subsubsection{\DIFadd{Food Deserts and Swamps}}\label{food-deserts-and-swamps}

\DIFadd{While there are many different community resources that can be the
...
\DIFadd{Much of the current research that has been done has shown a different
...
\DIFadd{However, areas that do not have any full service grocery stores however
...
\DIFadd{Past research done clearly shows that location of store, quality of
...
\DIFaddbegin \bibitem[\citeproctext]{ref-algert2006}
\DIFadd{Algert, S. J., Agrawal, A., \& Lewis, D. S. (2006). Disparities in
}{\DIFadd{Access}} \DIFadd{to }{\DIFadd{Fresh Produce}} \DIFadd{in }{\DIFadd{Low-Income Neighborhoods}} \DIFadd{in }{\DIFadd{Los
Angeles}}\DIFadd{. }\emph{\DIFadd{American Journal of Preventive Medicine}}\DIFadd{, }\emph{30}(5)\DIFadd{,
...
\DIFaddbegin \bibitem[\citeproctext]{ref-bao2020}
\DIFadd{Bao, K. Y., Tong, D., Plane, D. A., \& Buechler, S. (2020). Urban food
accessibility and diversity: }{\DIFadd{Exploring}} \DIFadd{the role of small non-chain
grocers. }\emph{\DIFadd{Applied Geography}}\DIFadd{, }\emph{\DIFadd{125}}\DIFadd{, 102275.
...
\DIFaddbegin \bibitem[\citeproctext]{ref-cass2005}
\DIFadd{Cass, N., Shove, E., \& Urry, J. (2005). Social }{\DIFadd{Exclusion}}\DIFadd{, }{\DIFadd{Mobility}}
\DIFadd{and }{\DIFadd{Access}}\DIFadd{. }\emph{\DIFadd{The Sociological Review}}\DIFadd{, }\emph{53}(3)\DIFadd{, 539--555.
...
\DIFaddbegin \bibitem[\citeproctext]{ref-currie2010}
\DIFadd{Currie, G., \& Delbosc, A. (2010). Modelling the social and
psychological impacts of transport disadvantage. }\emph{\DIFadd{Transportation}}\DIFadd{,
}\emph{37}(6)\DIFadd{, 953--966. }\url{https://doi.org/10.1007/s11116-010-9280-2}

\DIFaddend \bibitem[\citeproctext]{ref-dong2006}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-ermagun2020}
\DIFadd{Ermagun, A., \& Tilahun, N. (2020). Equity of transit accessibility
across }{\DIFadd{Chicago}}\DIFadd{. }\emph{\DIFadd{Transportation Research Part D: Transport and
Environment}}\DIFadd{, }\emph{\DIFadd{86}}\DIFadd{, 102461.
...
\DIFaddbegin \bibitem[\citeproctext]{ref-francis2012}
\DIFadd{Francis, J., Wood, L. J., Knuiman, M., \& Giles-Corti, B. (2012).
Quality or quantity? }{\DIFadd{Exploring}} \DIFadd{the relationship between }{\DIFadd{Public Open
Space}} \DIFadd{attributes and mental health in }{\DIFadd{Perth}}\DIFadd{, }{\DIFadd{Western Australia}}\DIFadd{.
}\emph{\DIFadd{Social Science \& Medicine}}\DIFadd{, }\emph{74}(10)\DIFadd{, 1570--1577.
}\url{https://doi.org/10.1016/j.socscimed.2012.01.032}

\DIFaddend \bibitem[\citeproctext]{ref-geurs2010}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-grengs2015}
\DIFadd{Grengs, J. (2015). Nonwork }{\DIFadd{Accessibility}} \DIFadd{as a }{\DIFadd{Social Equity
Indicator}}\DIFadd{. }\emph{\DIFadd{International Journal of Sustainable Transportation}}\DIFadd{,
}\emph{9}(1)\DIFadd{, 1--14. }\url{https://doi.org/10.1080/15568318.2012.719582}

\bibitem[\citeproctext]{ref-haboush2023healthy}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-hu2015}
\DIFadd{Hu, L. (2015). Job }{\DIFadd{Accessibility}} \DIFadd{of the }{\DIFadd{Poor}} \DIFadd{in }{\DIFadd{Los Angeles}}\DIFadd{.
}\emph{\DIFadd{Journal of the American Planning Association}}\DIFadd{, }\emph{81}(1)\DIFadd{,
...
\DIFaddbegin \bibitem[\citeproctext]{ref-losada-rojas2021}
\DIFadd{Losada-Rojas, L. L., Ke, Y., Pyrialakou, V. D., \& Konstantina Gkritza.
(2021). Access to healthy food in urban and rural areas: }{\DIFadd{An}} \DIFadd{empirical
analysis. }\emph{\DIFadd{Journal of Transport \& Health}}\DIFadd{, }\emph{\DIFadd{23}}\DIFadd{, 101245.
}\url{https://doi.org/10.1016/j.jth.2021.101245}

\DIFaddend \bibitem[\citeproctext]{ref-lunsford2021}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-madzia2019}
\DIFadd{Madzia, J., Ryan, P., Yolton, K., Percy, Z., Newman, N., LeMasters, G.,
\& Brokamp, C. (2019). Residential }{\DIFadd{Greenspace Association}} \DIFadd{with
}{\DIFadd{Childhood Behavioral Outcomes}}\DIFadd{. }\emph{\DIFadd{The Journal of Pediatrics}}\DIFadd{,
}\emph{\DIFadd{207}}\DIFadd{, 233--240. }\url{https://doi.org/10.1016/j.jpeds.2018.10.061}

\DIFaddend \bibitem[\citeproctext]{ref-mcfadden1974}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-schwanen2015}
\DIFadd{Schwanen, T., Lucas, K., Akyelken, N., Cisternas Solsona, D., Carrasco,
...
}\emph{\DIFadd{Transportation Research Part A: Policy and Practice}}\DIFadd{, }\emph{\DIFadd{74}}\DIFadd{,
...
\DIFaddbegin \bibitem[\citeproctext]{ref-witten2003}
\DIFadd{Witten, K., Exeter, D., \& Field, A. (2003). The }{\DIFadd{Quality}} \DIFadd{of }{\DIFadd{Urban
Environments}}\DIFadd{: }{\DIFadd{Mapping Variation}} \DIFadd{in }{\DIFadd{Access}} \DIFadd{to }{\DIFadd{Community Resources}}\DIFadd{.
}\emph{\DIFadd{Urban Studies}}\DIFadd{, }\emph{40}(1)\DIFadd{, 161--177.
}\url{https://doi.org/10.1080/00420980220080221}

\DIFaddend \bibitem[\citeproctext]{ref-wright2016}
