...
%DIF DEL submitted.tex                                                                                   Tue Apr 23 02:55:37 2024
%DIF ADD Where-s-dinner-coming-from--A-utility-based-investigation-of-access-to-nutrition-in-Utah..tex   Mon Jan 20 14:16:34 2025
...
%DIF 171-172c199-200
%DIF <   pdfkeywords={Accessibility, Access to nutrition, Passive location
%DIF < data},
%DIF -------
  pdfkeywords={Accessibility, Utility-based access, Access to %DIF > 
nutrition, Passive location data}, %DIF > 
%DIF -------
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
complete access to nutrition. \DIFaddbegin \DIFadd{Section~\ref{sec-conclude} places the
...
\DIFaddbegin \DIFadd{The nutrition access literature is long and has been approached from
...
\DIFadd{What has not been frequently attempted in the nutrition access
...
(}\textbf{\DIFadd{macfarlane2022a?}}\DIFadd{). The potential for application of this
...
(\DIFdelbegin \DIFdel{Macfarlane et al., 2022}\DIFdelend \DIFaddbegin \textbf{\DIFadd{macfarlane2022a?}}\DIFaddend ), relying on commercial location-based
...
Valley City. \DIFaddbegin \DIFadd{The communities are shown in a wider context in
...
\pandocbounded{\includegraphics[keepaspectratio]{03_methods_files/figure-pdf/fig-communities-1.pdf}}

}

\caption{\label{fig-communities}\DIFaddFL{Location of study regions in Utah.}}

\end{figure}%DIF > 

\DIFaddend Table~\ref{tbl-acsdata} shows several key population statistics based on
...
\caption{\label{tbl-acsdata}Demographic Statistics of Study \DIFdelbeginFL \DIFdelFL{Region}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Regions}\DIFaddendFL }
...
%DIFDELCMD < \begin{tabular}[t]{llrrrrrr}
%DIFDELCMD < \toprule
%DIFDELCMD < \multicolumn{2}{c}{ } & \multicolumn{2}{c}{Utah (N=63)} & \multicolumn{2}{c}{Salt Lake (N=39)} & \multicolumn{2}{c}{San Juan (N=50)} \\
%DIFDELCMD < \cmidrule(l{3pt}r{3pt}){3-4} \cmidrule(l{3pt}r{3pt}){5-6} \cmidrule(l{3pt}r{3pt}){7-8}
%DIFDELCMD <   &    & Mean & Std. Dev. & Mean & Std. Dev. & Mean & Std. Dev.\\
%DIFDELCMD < \midrule
%DIFDELCMD < Registers (incl. self checkout) &  & 12.5 & 11.7 & 9.9 & 8.9 & 6.1 & 8.8\\
%DIFDELCMD < NEMS-S availability score &  & 18.7 & 8.4 & 16.2 & 8.1 & 13.2 & 7.6\\
%DIFDELCMD < NEMS-S cost score &  & 1.9 & 2.3 & 2.3 & 2.2 & 1.9 & 1.9\\
%DIFDELCMD < Market basket cost &  & 126.1 & 21.5 & 141.6 & 19.2 & 157.6 & 16.8\\
%DIFDELCMD < \midrule
%DIFDELCMD <  &  & N & Pct. & N & Pct. & N & Pct.\\
%DIFDELCMD < Type & Convenience Store & 2 & 3.2 & 0 & 0.0 & 10 & 20.0\\
%DIFDELCMD <  & Dollar Store & 5 & 7.9 & 11 & 28.2 & 15 & 30.0\\
%DIFDELCMD <  & Grocery Store & 50 & 79.4 & 27 & 69.2 & 19 & 38.0\\
%DIFDELCMD <  & Other & 6 & 9.5 & 1 & 2.6 & 6 & 12.0\\
%DIFDELCMD < Pharmacy & FALSE & 42 & 66.7 & 32 & 82.1 & 43 & 86.0\\
%DIFDELCMD <  & TRUE & 21 & 33.3 & 7 & 17.9 & 7 & 14.0\\
%DIFDELCMD < Ethnic market & FALSE & 55 & 87.3 & 30 & 76.9 & 47 & 94.0\\
%DIFDELCMD <  & TRUE & 8 & 12.7 & 9 & 23.1 & 3 & 6.0\\
%DIFDELCMD < Other merchandise sold & FALSE & 52 & 82.5 & 35 & 89.7 & 47 & 94.0\\
%DIFDELCMD <  & TRUE & 11 & 17.5 & 4 & 10.3 & 3 & 6.0\\
...
\DIFdelbegin \subsubsection{\DIFdel{Imputation of Missing Store
Data}}%DIFAUXCMD
\addtocounter{subsubsection}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \paragraph{\DIFadd{Imputation of Missing Store
Data}}\DIFaddend \label{imputation-of-missing-store-data}

We collected detailed store attributes for \DIFaddbegin \DIFadd{a complete census of }\DIFaddend stores
...
choice models used to determine access \DIFdelbegin \DIFdel{, but }\DIFdelend \DIFaddbegin \DIFadd{and provide a complete picture of
access in those communities, assuming people do not leave the
communities for grocery trips. But }\DIFaddend understanding access in other parts
of Salt Lake \DIFdelbegin \DIFdel{City or the state of Utah }\DIFdelend \DIFaddbegin \DIFadd{County -- including how stores outside of the West Salt
Lake County area might shape access inside that community --- }\DIFaddend requires
us to impute the \DIFaddbegin \DIFadd{measured }\DIFaddend attributes onto the stores that we did not
\DIFdelbegin \DIFdel{collect}\DIFdelend \DIFaddbegin \DIFadd{directly measure}\DIFaddend .
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{03_methods_files/figure-pdf/fig-marketimp-1.pdf}

}
\DIFaddendFL 

\caption{\label{fig-marketimp}Imputed market price values for \DIFdelbeginFL \DIFdelFL{15 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12 }\DIFaddendFL random
grocery stores.}
...
set of \DIFdelbegin \DIFdel{15 }\DIFdelend \DIFaddbegin \DIFadd{12 }\DIFaddend stores. As the figure reveals, there is some general peaking
...
adapted from a statewide mode choice model \DIFaddbegin \DIFadd{for home-based non-work trips
in urban and rural regions }\DIFaddend developed for UDOT research (Barnes, 2021).
...
store. (\DIFdelbegin \DIFdel{Macfarlane et al., 2022}\DIFdelend \DIFaddbegin \textbf{\DIFadd{macfarlane2022a?}}\DIFaddend ) present a method for estimating
...
%DIFDELCMD < \includegraphics{04_estimation_files/figure-pdf/fig-nems-market-avail-1.pdf}
%DIFDELCMD < 
...
\pandocbounded{\includegraphics[keepaspectratio]{04_estimation_files/figure-pdf/fig-nems-market-avail-1.pdf}}
...
%DIFDELCMD < \includegraphics{04_estimation_files/figure-pdf/fig-nems-cost-avail-1.pdf}
%DIFDELCMD < 
...
\pandocbounded{\includegraphics[keepaspectratio]{04_estimation_files/figure-pdf/fig-nems-cost-avail-1.pdf}}
...
%DIFDELCMD < \midrule
%DIFDELCMD < Mode Choice Log-sum & 8.090** &  &  & 8.592**\\
%DIFDELCMD <  & (95.354) &  &  & (87.875)\\
%DIFDELCMD < NEMS Availability Score &  & 0.034** &  & -0.010**\\
%DIFDELCMD <  &  & (23.136) &  & (-3.191)\\
%DIFDELCMD < NEMS Cost Score &  & 0.029** &  & 0.035**\\
%DIFDELCMD <  &  & (6.344) &  & (5.075)\\
%DIFDELCMD < USDA Market Basket &  &  & -0.007** & -0.008**\\
%DIFDELCMD <  &  &  & (-8.943) & (-8.756)\\
%DIFDELCMD < Registers &  &  & 0.057** & 0.062**\\
%DIFDELCMD <  &  &  & (55.241) & (39.579)\\
%DIFDELCMD < Store Type: Dollar Store &  &  & 1.955** & 2.136**\\
%DIFDELCMD <  &  &  & (57.226) & (41.639)\\
%DIFDELCMD < Store Type: Convenience Store &  &  & -1.637** & -1.769**\\
%DIFDELCMD <  &  &  & (-7.256) & (-7.351)\\
%DIFDELCMD < Store Type: Other &  &  & -1.604** & -1.560**\\
%DIFDELCMD <  &  &  & (-12.267) & (-11.076)\\
%DIFDELCMD < \midrule
%DIFDELCMD < AIC & 31,798.55 & 49,021.43 & 42,045.1 & 25,587.52\\
%DIFDELCMD < $\rho^2_0$ & 0.36 & 0.014 & 0.154 & 0.485\\
%DIFDELCMD < \bottomrule
...
%DIFDELCMD <   & Access & NEMS & Attributes & All\\
%DIFDELCMD < \midrule
%DIFDELCMD < Mode Choice Log-sum & 9.767** &  &  & 11.924**\\
%DIFDELCMD <  & (73.003) &  &  & (73.366)\\
%DIFDELCMD < NEMS Availability Score &  & 0.135** &  & 0.010**\\
%DIFDELCMD <  &  & (73.114) &  & (2.627)\\
%DIFDELCMD < NEMS Cost Score &  & -0.039** &  & 0.049**\\
%DIFDELCMD <  &  & (-8.534) &  & (8.223)\\
%DIFDELCMD < USDA Market Basket &  &  & -0.009** & -0.006**\\
%DIFDELCMD <  &  &  & (-12.442) & (-6.686)\\
%DIFDELCMD < Registers &  &  & 0.106** & 0.128**\\
%DIFDELCMD <  &  &  & (71.242) & (51.661)\\
%DIFDELCMD < Store Type: Dollar Store &  &  & 0.301** & 0.530**\\
%DIFDELCMD <  &  &  & (6.618) & (9.354)\\
%DIFDELCMD < Store Type: Other &  &  & -0.024 & 0.320*\\
%DIFDELCMD <  &  &  & (-0.184) & (2.323)\\
%DIFDELCMD < \midrule
%DIFDELCMD < AIC & 43,025.99 & 42,037.02 & 39,775.88 & 31,636.5\\
%DIFDELCMD < $\rho^2_0$ & 0.134 & 0.154 & 0.2 & 0.364\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \multicolumn{5}{l}{\rule{0pt}{1em}* p $<$ 0.05, ** p $<$ 0.01}\\
%DIFDELCMD < \multicolumn{5}{l}{\rule{0pt}{1em}t-statistics in parentheses}\\
%DIFDELCMD < \end{tabular}
...
%DIFDELCMD <   & Access & NEMS & Attributes & All\\
%DIFDELCMD < \midrule
%DIFDELCMD < Mode Choice Log-sum & 0.732** &  &  & 1.233**\\
%DIFDELCMD <  & (83.411) &  &  & (74.178)\\
%DIFDELCMD < NEMS Availability Score &  & 0.134** &  & 0.049**\\
%DIFDELCMD <  &  & (61.893) &  & (10.191)\\
%DIFDELCMD < NEMS Cost Score &  & 0.249** &  & 0.072**\\
%DIFDELCMD <  &  & (38.689) &  & (8.690)\\
%DIFDELCMD < USDA Market Basket &  &  & -0.010** & -0.031**\\
%DIFDELCMD <  &  &  & (-13.568) & (-23.484)\\
%DIFDELCMD < Registers &  &  & 0.022** & 0.052**\\
%DIFDELCMD <  &  &  & (20.793) & (27.317)\\
%DIFDELCMD < Store Type: Dollar Store &  &  & -2.126** & -1.443**\\
%DIFDELCMD <  &  &  & (-47.105) & (-20.779)\\
%DIFDELCMD < Store Type: Convenience Store &  &  & -3.720** & -1.376**\\
%DIFDELCMD <  &  &  & (-31.352) & (-9.810)\\
%DIFDELCMD < Store Type: Other &  &  & -1.567** & -1.574**\\
%DIFDELCMD <  &  &  & (-29.544) & (-22.209)\\
%DIFDELCMD < \midrule
%DIFDELCMD < AIC & 40,351.12 & 35,021.59 & 37,361.16 & 23,143.56\\
%DIFDELCMD < $\rho^2_0$ & 0.188 & 0.295 & 0.248 & 0.535\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \multicolumn{5}{l}{\rule{0pt}{1em}* p $<$ 0.05, ** p $<$ 0.01}\\
%DIFDELCMD < \multicolumn{5}{l}{\rule{0pt}{1em}t-statistics in parentheses}\\
%DIFDELCMD < \end{tabular}
...
%DIFDELCMD < \includegraphics[width=6in,height=\textheight]{04_estimation_files/figure-pdf/fig-all-comp-1.pdf}
%DIFDELCMD < 
...
\pandocbounded{\includegraphics[keepaspectratio]{04_estimation_files/figure-pdf/fig-all-comp-1.pdf}}

}
\DIFaddendFL 

\caption{\label{fig-all-comp}\DIFdelbeginFL \DIFdelFL{Comparison }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Average change in the probability }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{county }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the
chosen alternative with respect to a 100\% change in }\DIFaddendFL model \DIFdelbeginFL \DIFdelFL{coefficient
estimates}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{variables}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{Absolute square root transformation applied to improve
visibility.}\DIFdelendFL }

\end{figure}%

To better visualize how the preferences in the three communities differ
from each other, Figure~\ref{fig-all-comp} plots the \DIFdelbegin \DIFdel{coefficient
estimates from the All model in each community. }\DIFdelend \DIFaddbegin \DIFadd{average marginal
...
interval. }\DIFaddend The mode choice log-sum \DIFaddbegin \DIFadd{elasticity }\DIFaddend is strongly significant in
all three communities \DIFaddbegin \DIFadd{(and is the most influential variable on choice)}\DIFaddend ,
...
\DIFdelbegin \DIFdel{Most other estimates are somewhat
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{04_estimation_files/figure-pdf/fig-map-ut-1.pdf}
...
%DIFDELCMD < \includegraphics[width=4in,height=\textheight]{04_estimation_files/figure-pdf/fig-map-nocar-1.pdf}
%DIFDELCMD < 
...
\includegraphics[width=4in,height=\textheight,keepaspectratio]{04_estimation_files/figure-pdf/fig-map-nocar-1.pdf}
...
%DIFDELCMD < \includegraphics[width=4in,height=\textheight]{04_estimation_files/figure-pdf/fig-map-nocar-2.pdf}
%DIFDELCMD < 
...
\includegraphics[width=4in,height=\textheight,keepaspectratio]{04_estimation_files/figure-pdf/fig-map-nocar-2.pdf}
...
\mathrm{Benefit} = \sum_{i}\left(-\frac{\omega_i}{\beta_{mkt}}(CS_i\DIFdelbegin \DIFdel{^1 }\DIFdelend \DIFaddbegin \DIFadd{' }\DIFaddend - CS_i\DIFdelbegin \DIFdel{^1}\DIFdelend )\right)
\] \DIFdelbegin \DIFdel{where }\DIFdelend \DIFaddbegin \DIFadd{with the consumer surplus of the ``improved'' scenario in each origin
zone \(i\) indicated as \(CS_i'\) and the unimproved counterpart as
\(CS_i\), }\DIFaddend a weight \(\omega\) accounts for the population in \DIFdelbegin \DIFdel{each origin
zone\(i\) }\DIFdelend \DIFaddbegin \DIFadd{the zone,
}\DIFaddend and the \(\beta_{mkt}\) converts the difference in utility into a dollar
amount.
...
\DIFaddbegin \item
  \DIFadd{Increase the availability of grocery delivery in the region.
}\DIFaddend \end{enumerate}

We implement all three strategies in scenarios on the west Salt Lake
valley community. We also implement strategy \DIFdelbegin \DIFdel{1 (a new }\DIFdelend \DIFaddbegin \DIFadd{2 (an improved }\DIFaddend store) in
...
an idealized \DIFdelbegin \DIFdel{Euclidean }\DIFdelend distance function,
...
\DIFaddbegin \DIFadd{Presently, the }\emph{\DIFadd{mean}} \DIFadd{walk access time in the scenario region is
...
\DIFaddbegin \subsubsection{\DIFadd{Grocery delivery
services}}\label{grocery-delivery-services}

\DIFadd{This strategy assumes that the most effective way to bring quality
...
\DIFaddend \subsection{Scenario Results}\label{scenario-results}
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s1results-1.pdf}
...
where they exceed \DIFdelbegin \DIFdel{\(317\) }\DIFdelend \DIFaddbegin \DIFadd{\(3\) }\DIFaddend for each household each time the household makes
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s2results-1.pdf}
...
\includegraphics[width=4in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s2sjut-1.pdf}
...
\includegraphics[width=4in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s2sjut-2.pdf}
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s3results-1.pdf}
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{05_scenarios_files/figure-pdf/fig-s4results-1.pdf}

}

\caption{\label{fig-s4results}\DIFaddFL{Estimated per-household benefits of
...
%DIFDELCMD < \toprule
%DIFDELCMD < \multicolumn{1}{c}{ } & \multicolumn{3}{c}{Weighted by} \\
%DIFDELCMD < \cmidrule(l{3pt}r{3pt}){2-4}
%DIFDELCMD < Scenario & Households & Non-white & Low-Income\\
%DIFDELCMD < \midrule
%DIFDELCMD < New Store & \$11,145,542,384 & \$3,051,365,881 & \$1,766,485,839\\
%DIFDELCMD < \addlinespace[0.3em]
%DIFDELCMD < \multicolumn{4}{l}{\textbf{Improved Store}}\\
%DIFDELCMD < \hspace{1em}Salt Lake Valley & \$8,597,772 & \$4,187,114 & \$1,760,422\\
%DIFDELCMD < \hspace{1em}Utah County & \$1,621,027 & \$260,360 & \$249,142\\
%DIFDELCMD < \hspace{1em}San Juan County & \$355,512 & \$157,715 & \$114,897\\
%DIFDELCMD < Improved Transport & \$2,024,639 & \$922,766 & \$287,064\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < 
...
low-income \DIFdelbegin \DIFdel{households }\DIFdelend \DIFaddbegin \DIFadd{and zero-vehicle zero-vehicle }\DIFaddend respectively. All demographic
data comes from the American Community Survey \DIFaddbegin \DIFadd{(ACS) }\DIFaddend 5-year aggregations\DIFaddbegin \DIFadd{;
...
refined block group level}\DIFaddend .
...
benefit of approximately \$\DIFdelbegin \DIFdel{5.5 }\DIFdelend \DIFaddbegin \DIFadd{13 }\DIFaddend million. Of this amount, somewhat less
...
\DIFaddbegin \DIFadd{By far the highest benefit observed in these scenarios is the increased
...
\DIFaddend \bookmarksetup{startatroot}
...
options, it is not a typical peak time for grocery shopping. \DIFaddbegin \DIFadd{The mode
choice model was also selected for general convenience, and not fully
calibrated to grocery trips in the specific regions. }\DIFaddend All of these
limitations could potentially be relaxed by using a synthetic population
with detailed socioeconomic data and parcel-level \DIFdelbegin \DIFdel{locations
}\DIFdelend \DIFaddbegin \DIFadd{location choices
}\DIFaddend determined by an activity-based model, as proposed by (Dong et al.,
...
\DIFaddbegin \bibitem[\citeproctext]{ref-aggarwal2014}
\DIFadd{Aggarwal, A., Cook, A. J., Jiao, J., Seguin, R. A., Vernez Moudon, A.,
Hurvitz, P. M., \& Drewnowski, A. (2014). Access to }{\DIFadd{Supermarkets}} \DIFadd{and
}{\DIFadd{Fruit}} \DIFadd{and }{\DIFadd{Vegetable Consumption}}\DIFadd{. }\emph{\DIFadd{American Journal of Public
Health}}\DIFadd{, }\emph{104}(5)\DIFadd{, 917--923.
...
\DIFdelbegin \bibitem[\citeproctext]{ref-macfarlane2022a}
\DIFdelend \DIFaddbegin \bibitem[\citeproctext]{ref-macfarlane2021b}
\DIFaddend Macfarlane, G. \DIFdelbegin \DIFdel{, Voulgaris, C.T. , \& Tapia, T. (2022).
City parks and
slow streets}\DIFdelend \DIFaddbegin \DIFadd{S., Boyd, N., Taylor, J. E., \& Watkins, K. (2021).
Modeling the impacts of park access on health outcomes}\DIFaddend : {A}
utility-based \DIFdelbegin \DIFdel{access and equity analysis. }\DIFdelend \DIFaddbegin \DIFadd{accessibility approach. }\DIFaddend \emph{\DIFdelbegin \DIFdel{Journal of Transport }\DIFdelend \DIFaddbegin \DIFadd{Environment }\DIFaddend and \DIFdelbegin \DIFdel{Land Use}\DIFdelend \DIFaddbegin \DIFadd{Planning B:
Urban Analytics and City Science}\DIFaddend }, \DIFdelbegin %DIFDELCMD < \emph{15}(1)%%%
\DIFdel{, 587--612.
}%DIFDELCMD < \url{https://doi.org/10.5198/jtlu.2022.2009}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \emph{48}(8)\DIFadd{, 2289--2306.
...
105--142). Academic Press\DIFaddbegin \DIFadd{.
}

\bibitem[\citeproctext]{ref-moore2022}
\DIFadd{Moore, D. V. (2022). Predatory }{\DIFadd{Pricing}}\DIFadd{, }{\DIFadd{Network Effects}}\DIFadd{, and the
}{\DIFadd{Food Delivery Industry}}\DIFadd{: }{\DIFadd{A Case Study}}\DIFadd{. }\emph{\DIFadd{Northern Kentucky Law
Review}}\DIFadd{, }\emph{49}(1)\DIFadd{, 93--114}\DIFaddend .
