...
%DIF ADD Where-s-dinner-coming-from--A-utility-based-investigation-of-access-to-nutrition-in-Utah..tex   Tue May 14 20:44:08 2024
...
between the two. (G. S. Macfarlane et al., 2021) illustrated the
potential for a utility-based model of access to establish relationships
between urban green space access and health, and then continued that
methodology into a policy analysis of park space during Covid-19 (G.
Macfarlane et al., 2022). The potential for application of this
...
(\DIFaddbegin \DIFadd{G. }\DIFaddend Macfarlane et al., 2022), relying on commercial location-based
...
\DIFaddbegin \bibitem[\citeproctext]{ref-macfarlane2021b}
\DIFadd{Macfarlane, G. S., Boyd, N., Taylor, J. E., \& Watkins, K. (2021).
Modeling the impacts of park access on health outcomes: }{\DIFadd{A}}
\DIFadd{utility-based accessibility approach. }\emph{\DIFadd{Environment and Planning B:
Urban Analytics and City Science}}\DIFadd{, }\emph{48}(8)\DIFadd{, 2289--2306.
}\url{https://doi.org/10.1177/2399808320974027}

\DIFaddend \bibitem[\citeproctext]{ref-macfarlane2022a}
